...
face_cascade = cv2.CascadeClassifier('C:/Users/justi/Desktop/Unmasked2Ripo/UnmaskedVersion2/Unmasked_V2/project/Facial_Recog/Cascades/data/haarcascade_frontalface_alt2.xml')
profile_cascade = cv2.CascadeClassifier('C:/Users/justi/Desktop/Unmasked2Ripo/UnmaskedVersion2/Unmasked_V2/project/Facial_Recog/Cascades/data/haarcascade_profileface.xml')
...
def capture():
    ...
    InitialFaceDetection = False
    ContinousFaceDetection = False
    TimeElapsed = False
    ...
    while True:
        ...
        sideprof = profile_cascade.detectMultiScale(gray, scaleFactor=1.5, minNeighbors=4)
        R1 = None
        R2 = None
        #Rectangle
    ...
    # Get a keyboard key input to stop webcam
        key=cv2.waitKey(1)
        if key == 112: #p
            break
